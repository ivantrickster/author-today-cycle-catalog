...
### Готовая версия из ZIP

1. Откройте [последний выпуск на GitHub](https://github.com/ivantrickster/author-today-cycle-catalog/releases/latest).
2. В разделе **Assets** скачайте архив `author-today-cycle-catalog-v0.18.4.zip`.
3. Распакуйте архив в постоянную папку. Не удаляйте и не перемещайте её после установки.
4. Откройте страницу расширений: `chrome://extensions`, `edge://extensions` или `browser://extensions` в Яндекс.Браузере.
5. Включите «Режим разработчика».
6. Нажмите «Загрузить распакованное» и выберите распакованную папку — внутри неё должен находиться файл `manifest.json`.
7. Закрепите расширение на панели браузера и подтвердите условия при первом запуске.

Версия, установленная из ZIP, не обновляется автоматически. Для обновления скачайте новый архив, замените файлы в той же папке и нажмите кнопку обновления на странице расширений.
